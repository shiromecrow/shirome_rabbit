...
switch (main_modeL) {
	...
	break;
	case 0b1000:
		testturning(speed1200_shortest_mollifier,main_modeR,1,ON,5.9,1);
	break;
	case 0b1001:
		testturning(speed1400_shortest_mollifier,main_modeR,1,ON,5.9,1);
	break;
	case 0b1010:
	break;
	case 0b1011:
...
void mode_Running(unsigned char main_modeR){
	...
	switch (main_modeR) {
		...
		case 0b0101://
			record_out();
			run_shortest(1000,3000,3000,TURN_ON,FUN_OFF,SLANT_OFF,speed600_shortest_mollifier,5.6,1,0);
		break;
		case 0b0110://吸引なしで斜め走行
			record_out();
			run_shortest(1000,3000,3000,TURN_ON,FUN_OFF,SLANT_ON,speed600_shortest_mollifier,5.6,1,0);
		break;
		...
		case 0b1001:
			record_out();
			run_shortest(4000,18000,18000,TURN_ON,FUN_ON,SLANT_ON,speed1400_shortest_mollifier,5.9,1,0);
		break;
		case 0b1010:
			record_out();
			run_shortest(4000,22000,22000,TURN_ON,FUN_ON,SLANT_ON,speed1400_shortest_mollifier,5.9,1,0);
		break;
		case 0b1011:
			record_out();
			run_shortest(5000,25000,25000,TURN_ON,FUN_ON,SLANT_ON,speed1400_shortest_mollifier,5.9,1,0);
		break;
		case 0b1100:
			record_out();
			run_shortest(3000,12000,12000,TURN_ON,FUN_ON,SLANT_ON,speed1400_shortest_mollifier,5.9,1,0);
		break;
		case 0b1101:
			record_out();
			run_shortest(4000,13000,14000,TURN_ON,FUN_ON,SLANT_ON,speed1200_shortest_mollifier,5.9,1,2);
		break;
		case 0b1110:
			record_out();
			run_shortest(4000,17000,20000,TURN_ON,FUN_ON,SLANT_ON,speed1200_shortest_mollifier,5.9,1,2);
...
void mode_Running2(unsigned char main_modeR){
	...
	switch (main_modeR) {
		...
		case 0b0010:
			record_out();
			run_shortest(4000,13000,14000,TURN_ON,FUN_ON,SLANT_ON,speed1600_shortest_mollifier,5.6,1,2);
		break;
		case 0b0011:
			record_out();
			run_shortest(4000,17000,20000,TURN_ON,FUN_ON,SLANT_ON,speed1600_shortest_mollifier,5.6,1,2);
		break;
		case 0b0100:
...
//				printf("SEN45R=%d,Sdis45R=%f\n",g_sensor[SENSOR_FRONT_RIGHT][0],g_sensor_distance_slant[SENSOR_FRONT_RIGHT]);
				...
				printf("Sdis90L=%f,Sdis90R=%f,Sdis45L=%f,Sdis45R=%f\n"
						,g_sensor_distance_slant[SENSOR_LEFT],g_sensor_distance_slant[SENSOR_RIGHT]
						,g_sensor_distance_slant[SENSOR_FRONT_LEFT],g_sensor_distance_slant[SENSOR_FRONT_RIGHT]);
				wait_ms(500);
			}
		break;
		case 4://探索用壁切れの確認

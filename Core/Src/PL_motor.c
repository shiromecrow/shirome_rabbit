...
break;
case MOTOR_FRONT:
	HAL_GPIO_WritePin(MOTOR_L_CWCCW_GPIO_Port,MOTOR_L_CWCCW_Pin,L_MOTOR_FRONT);
break;
case MOTOR_BACK:
	HAL_GPIO_WritePin(MOTOR_L_CWCCW_GPIO_Port,MOTOR_L_CWCCW_Pin,L_MOTOR_BACK);
break;
case MOTOR_BREAK:
	//pin_mode変更で実装したい
break;
...
break;
case MOTOR_FRONT:
	HAL_GPIO_WritePin(MOTOR_R_CWCCW_GPIO_Port,MOTOR_R_CWCCW_Pin,R_MOTOR_FRONT);
break;
case MOTOR_BACK:
	HAL_GPIO_WritePin(MOTOR_R_CWCCW_GPIO_Port,MOTOR_R_CWCCW_Pin,R_MOTOR_BACK);
break;
case MOTOR_BREAK:
	//pin_mode変更で実装したい
break;

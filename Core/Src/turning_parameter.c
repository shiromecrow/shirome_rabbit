...
parameter_speed speed1800_shortest_mollifier;
...
//********************************600********************************************
	...
	//********************************1000********************************************
		...
		speed1000_shortest_mollifier.turn90_R.f_ofset = 34;
		...
		speed1000_shortest_mollifier.turn90_L.f_ofset = 34;
		speed1000_shortest_mollifier.turn90_L.e_ofset = 30;

		speed1000_shortest_mollifier.turn180_R.g_speed =1000;
		speed1000_shortest_mollifier.turn180_R.t_speed = 1440;
		...
		speed1000_shortest_mollifier.turn180_L.t_speed = 1440;
		...
		speed1000_shortest_mollifier.turn45in_R.t_speed = 1250;
		speed1000_shortest_mollifier.turn45in_R.f_ofset = 22;
		speed1000_shortest_mollifier.turn45in_R.e_ofset = 34;

		speed1000_shortest_mollifier.turn45in_L.g_speed = 1000;
		speed1000_shortest_mollifier.turn45in_L.t_speed = 1250;
		speed1000_shortest_mollifier.turn45in_L.f_ofset = 22;
		speed1000_shortest_mollifier.turn45in_L.e_ofset = 34;

		speed1000_shortest_mollifier.turn135in_R.g_speed = 1000;
		speed1000_shortest_mollifier.turn135in_R.t_speed = 1530;
		speed1000_shortest_mollifier.turn135in_R.f_ofset = 16;
		speed1000_shortest_mollifier.turn135in_R.e_ofset = 15;

		speed1000_shortest_mollifier.turn135in_L.g_speed = 1000;
		speed1000_shortest_mollifier.turn135in_L.t_speed = 1530;
		speed1000_shortest_mollifier.turn135in_L.f_ofset = 16;
		speed1000_shortest_mollifier.turn135in_L.e_ofset = 12;

		speed1000_shortest_mollifier.turn45out_R.g_speed = 1000;
		speed1000_shortest_mollifier.turn45out_R.t_speed = 1200;
		speed1000_shortest_mollifier.turn45out_R.f_ofset = 37;
		speed1000_shortest_mollifier.turn45out_R.e_ofset = 22;

		speed1000_shortest_mollifier.turn45out_L.g_speed = 1000;
		speed1000_shortest_mollifier.turn45out_L.t_speed = 1200;
		speed1000_shortest_mollifier.turn45out_L.f_ofset = 37;
		...
		speed1000_shortest_mollifier.turn135out_R.f_ofset = 18;
		...
		speed1000_shortest_mollifier.turn135out_L.f_ofset = 17;
		speed1000_shortest_mollifier.turn135out_L.e_ofset = 30;

		speed1000_shortest_mollifier.V90_R.g_speed = 1000;
		speed1000_shortest_mollifier.V90_R.t_speed = 1700;
		speed1000_shortest_mollifier.V90_R.f_ofset = 15;
		speed1000_shortest_mollifier.V90_R.e_ofset = 23;

		speed1000_shortest_mollifier.V90_L.g_speed = 1000;
		speed1000_shortest_mollifier.V90_L.t_speed = 1700;
		...
		//********************************1200********************************************
			...
			//********************************1400********************************************
				...
				speed1400_shortest_mollifier.turn90_R.e_ofset = 21;

				speed1400_shortest_mollifier.turn90_L.g_speed = 1400;
				speed1400_shortest_mollifier.turn90_L.t_speed = 1650;
				speed1400_shortest_mollifier.turn90_L.f_ofset = 12;
				speed1400_shortest_mollifier.turn90_L.e_ofset = 21;

				speed1400_shortest_mollifier.turn180_R.g_speed =1400;
				speed1400_shortest_mollifier.turn180_R.t_speed = 2000;
				speed1400_shortest_mollifier.turn180_R.f_ofset = 12;
				speed1400_shortest_mollifier.turn180_R.e_ofset = 19;

				speed1400_shortest_mollifier.turn180_L.g_speed = 1400;
				speed1400_shortest_mollifier.turn180_L.t_speed = 2050;
				speed1400_shortest_mollifier.turn180_L.f_ofset = 12;
				...
				speed1400_shortest_mollifier.turn45in_R.f_ofset = 15;
				speed1400_shortest_mollifier.turn45in_R.e_ofset = 40;

				speed1400_shortest_mollifier.turn45in_L.g_speed = 1400;
				speed1400_shortest_mollifier.turn45in_L.t_speed = 1800;
				speed1400_shortest_mollifier.turn45in_L.f_ofset = 15;
				speed1400_shortest_mollifier.turn45in_L.e_ofset = 47;

				speed1400_shortest_mollifier.turn135in_R.g_speed = 1400;
				speed1400_shortest_mollifier.turn135in_R.t_speed = 2310;
				speed1400_shortest_mollifier.turn135in_R.f_ofset = 23;
				speed1400_shortest_mollifier.turn135in_R.e_ofset = 25;

				speed1400_shortest_mollifier.turn135in_L.g_speed = 1400;
				speed1400_shortest_mollifier.turn135in_L.t_speed = 2310;
				speed1400_shortest_mollifier.turn135in_L.f_ofset = 23;
				speed1400_shortest_mollifier.turn135in_L.e_ofset = 25;

				speed1400_shortest_mollifier.turn45out_R.g_speed = 1400;
				speed1400_shortest_mollifier.turn45out_R.t_speed = 1600;
				speed1400_shortest_mollifier.turn45out_R.f_ofset = 28;
				speed1400_shortest_mollifier.turn45out_R.e_ofset = 25;

				speed1400_shortest_mollifier.turn45out_L.g_speed = 1400;
				speed1400_shortest_mollifier.turn45out_L.t_speed = 1600;
				speed1400_shortest_mollifier.turn45out_L.f_ofset = 28;
				speed1400_shortest_mollifier.turn45out_L.e_ofset = 23;

				speed1400_shortest_mollifier.turn135out_R.g_speed = 1400;
				speed1400_shortest_mollifier.turn135out_R.t_speed = 2400;
				speed1400_shortest_mollifier.turn135out_R.f_ofset = 12;
				speed1400_shortest_mollifier.turn135out_R.e_ofset = 30;

				speed1400_shortest_mollifier.turn135out_L.g_speed = 1400;
				speed1400_shortest_mollifier.turn135out_L.t_speed = 2400;
				speed1400_shortest_mollifier.turn135out_L.f_ofset = 12;
				speed1400_shortest_mollifier.turn135out_L.e_ofset = 28;

				speed1400_shortest_mollifier.V90_R.g_speed = 1300;
				speed1400_shortest_mollifier.V90_R.t_speed = 2400;
				speed1400_shortest_mollifier.V90_R.f_ofset = 13;
				speed1400_shortest_mollifier.V90_R.e_ofset = 30;

				speed1400_shortest_mollifier.V90_L.g_speed = 1300;
				speed1400_shortest_mollifier.V90_L.t_speed = 2400;
				speed1400_shortest_mollifier.V90_L.f_ofset = 12;
				speed1400_shortest_mollifier.V90_L.e_ofset = 30;

//********************************1600********************************************
			//********************************1400********************************************
				speed1600_shortest_mollifier.SlalomCentervelocity = 1600;
				speed1600_shortest_mollifier.TurnCentervelocity = 1600;
				...
				speed1600_shortest_mollifier.turn90_R.g_speed = 2000;
				speed1600_shortest_mollifier.turn90_R.t_speed = 2700;
				speed1600_shortest_mollifier.turn90_R.f_ofset = 9;
				speed1600_shortest_mollifier.turn90_R.e_ofset = 42;

				speed1600_shortest_mollifier.turn90_L.g_speed = 2000;
				speed1600_shortest_mollifier.turn90_L.t_speed = 2700;
				speed1600_shortest_mollifier.turn90_L.f_ofset = 8;
				speed1600_shortest_mollifier.turn90_L.e_ofset = 44;

				speed1600_shortest_mollifier.turn180_R.g_speed =1800;
				speed1600_shortest_mollifier.turn180_R.t_speed = 2750;
				speed1600_shortest_mollifier.turn180_R.f_ofset = 17;
				speed1600_shortest_mollifier.turn180_R.e_ofset = 53;

				speed1600_shortest_mollifier.turn180_L.g_speed = 1800;
				speed1600_shortest_mollifier.turn180_L.t_speed = 2750;
				speed1600_shortest_mollifier.turn180_L.f_ofset = 18;
				speed1600_shortest_mollifier.turn180_L.e_ofset = 53;

				speed1600_shortest_mollifier.turn45in_R.g_speed = 1750;
				speed1600_shortest_mollifier.turn45in_R.t_speed = 2300;
				speed1600_shortest_mollifier.turn45in_R.f_ofset = 5;
				speed1600_shortest_mollifier.turn45in_R.e_ofset = 48;

				speed1600_shortest_mollifier.turn45in_L.g_speed = 1750;
				speed1600_shortest_mollifier.turn45in_L.t_speed = 2300;
				speed1600_shortest_mollifier.turn45in_L.f_ofset = 5;
				speed1600_shortest_mollifier.turn45in_L.e_ofset = 48;

				speed1600_shortest_mollifier.turn135in_R.g_speed = 1750;
				speed1600_shortest_mollifier.turn135in_R.t_speed = 2800;
				speed1600_shortest_mollifier.turn135in_R.f_ofset = 8;
				speed1600_shortest_mollifier.turn135in_R.e_ofset = 37;

				speed1600_shortest_mollifier.turn135in_L.g_speed = 1750;
				speed1600_shortest_mollifier.turn135in_L.t_speed = 2800;
				speed1600_shortest_mollifier.turn135in_L.f_ofset = 4;
				speed1600_shortest_mollifier.turn135in_L.e_ofset = 37;

				speed1600_shortest_mollifier.turn45out_R.g_speed = 1800;
				speed1600_shortest_mollifier.turn45out_R.t_speed = 2000;
				speed1600_shortest_mollifier.turn45out_R.f_ofset = 27;
				speed1600_shortest_mollifier.turn45out_R.e_ofset = 20;

				speed1600_shortest_mollifier.turn45out_L.g_speed = 1800;
				speed1600_shortest_mollifier.turn45out_L.t_speed = 2000;
				speed1600_shortest_mollifier.turn45out_L.f_ofset = 22;
				speed1600_shortest_mollifier.turn45out_L.e_ofset = 25;

				speed1600_shortest_mollifier.turn135out_R.g_speed = 1750;
				speed1600_shortest_mollifier.turn135out_R.t_speed = 2950;
				speed1600_shortest_mollifier.turn135out_R.f_ofset = 14;
				speed1600_shortest_mollifier.turn135out_R.e_ofset = 43;

				speed1600_shortest_mollifier.turn135out_L.g_speed = 1750;
				speed1600_shortest_mollifier.turn135out_L.t_speed = 2950;
				speed1600_shortest_mollifier.turn135out_L.f_ofset = 13;
				speed1600_shortest_mollifier.turn135out_L.e_ofset = 43;

				speed1600_shortest_mollifier.V90_R.g_speed = 1600;
				speed1600_shortest_mollifier.V90_R.t_speed = 3000;
				speed1600_shortest_mollifier.V90_R.f_ofset = 12.5;
				...
				//********************************1800********************************************
				speed1800_shortest_mollifier.SlalomCentervelocity = 1800;
				speed1800_shortest_mollifier.TurnCentervelocity = 1800;

				speed1800_shortest_mollifier.slalom_R.g_speed =
						speed1800_shortest_mollifier.SlalomCentervelocity;
				speed1800_shortest_mollifier.slalom_R.t_speed = 1100;
				speed1800_shortest_mollifier.slalom_R.f_ofset = 5;
				speed1800_shortest_mollifier.slalom_R.e_ofset = 28;

				speed1800_shortest_mollifier.slalom_L.g_speed =
						speed1800_shortest_mollifier.SlalomCentervelocity;
				speed1800_shortest_mollifier.slalom_L.t_speed = 1100;
				speed1800_shortest_mollifier.slalom_L.f_ofset = 5;
				speed1800_shortest_mollifier.slalom_L.e_ofset = 32;

				speed1800_shortest_mollifier.turn90_R.g_speed = 2200;
				speed1800_shortest_mollifier.turn90_R.t_speed = 3200;
				speed1800_shortest_mollifier.turn90_R.f_ofset = 9;
				speed1800_shortest_mollifier.turn90_R.e_ofset = 57;

				speed1800_shortest_mollifier.turn90_L.g_speed = 2200;
				speed1800_shortest_mollifier.turn90_L.t_speed = 3200;
				speed1800_shortest_mollifier.turn90_L.f_ofset = 10;
				speed1800_shortest_mollifier.turn90_L.e_ofset = 60;

				speed1800_shortest_mollifier.turn180_R.g_speed =2000;
				speed1800_shortest_mollifier.turn180_R.t_speed = 2900;
				speed1800_shortest_mollifier.turn180_R.f_ofset = 7;
				speed1800_shortest_mollifier.turn180_R.e_ofset = 63;

				speed1800_shortest_mollifier.turn180_L.g_speed = 2000;
				speed1800_shortest_mollifier.turn180_L.t_speed = 2950;
				speed1800_shortest_mollifier.turn180_L.f_ofset = 8;
				speed1800_shortest_mollifier.turn180_L.e_ofset = 63;

				speed1800_shortest_mollifier.turn45in_R.g_speed = 2000;
				speed1800_shortest_mollifier.turn45in_R.t_speed = 2900;
				speed1800_shortest_mollifier.turn45in_R.f_ofset = 3;
				speed1800_shortest_mollifier.turn45in_R.e_ofset = 69;

				speed1800_shortest_mollifier.turn45in_L.g_speed = 2000;
				speed1800_shortest_mollifier.turn45in_L.t_speed = 2900;
				speed1800_shortest_mollifier.turn45in_L.f_ofset = 3;
				speed1800_shortest_mollifier.turn45in_L.e_ofset = 69;

				speed1800_shortest_mollifier.turn135in_R.g_speed = 2000;
				speed1800_shortest_mollifier.turn135in_R.t_speed = 3300;
				speed1800_shortest_mollifier.turn135in_R.f_ofset = 8;
				speed1800_shortest_mollifier.turn135in_R.e_ofset = 63;

				speed1800_shortest_mollifier.turn135in_L.g_speed = 2000;
				speed1800_shortest_mollifier.turn135in_L.t_speed = 3300;
				speed1800_shortest_mollifier.turn135in_L.f_ofset = 7;
				speed1800_shortest_mollifier.turn135in_L.e_ofset = 63;

				speed1800_shortest_mollifier.turn45out_R.g_speed = 2100;
				speed1800_shortest_mollifier.turn45out_R.t_speed = 3000;
				speed1800_shortest_mollifier.turn45out_R.f_ofset = 22;
				speed1800_shortest_mollifier.turn45out_R.e_ofset = 35;

				speed1800_shortest_mollifier.turn45out_L.g_speed = 2100;
				speed1800_shortest_mollifier.turn45out_L.t_speed = 3000;
				speed1800_shortest_mollifier.turn45out_L.f_ofset = 22;
				speed1800_shortest_mollifier.turn45out_L.e_ofset = 35;

				speed1800_shortest_mollifier.turn135out_R.g_speed = 1850;
				speed1800_shortest_mollifier.turn135out_R.t_speed = 3300;
				speed1800_shortest_mollifier.turn135out_R.f_ofset = 19;
				speed1800_shortest_mollifier.turn135out_R.e_ofset = 50;

				speed1800_shortest_mollifier.turn135out_L.g_speed = 1850;
				speed1800_shortest_mollifier.turn135out_L.t_speed = 3300;
				speed1800_shortest_mollifier.turn135out_L.f_ofset = 20;
				speed1800_shortest_mollifier.turn135out_L.e_ofset = 50;

				speed1800_shortest_mollifier.V90_R.g_speed = 1750;
				speed1800_shortest_mollifier.V90_R.t_speed = 3300;
				speed1800_shortest_mollifier.V90_R.f_ofset = 13;
				speed1800_shortest_mollifier.V90_R.e_ofset = 58;

				speed1800_shortest_mollifier.V90_L.g_speed = 1750;
				speed1800_shortest_mollifier.V90_L.t_speed = 3300;
				speed1800_shortest_mollifier.V90_L.f_ofset = 10;
				speed1800_shortest_mollifier.V90_L.e_ofset = 58;
